...
function isStyledComponentsLike (element) {
  ...
  return !element.textContent && (((_a = element.sheet) === null || _a === undefined ? undefined : _a.cssRules.length) || ((_b = getCachedRules(element)) === null || _b === undefined ? undefined : _b.length))
}
...
function getNewAppendChild () {
  ...
  return function appendChild (newChild) {
    ...
    if (element.tagName) {
      ...
      var appName_1 = _a[0]
      var appWrapperGetter = _a[1]
      var proxy = _a[2]
      var singular = _a[3]
      var dynamicStyleSheetElements = _a[4]
...
function getNewInsertBefore () {
  ...
  return function insertBefore (newChild, refChild) {
    ...
    if (element.tagName) {
      ...
      var appWrapperGetter = _a[1]
      var singular = _a[2]
      var dynamicStyleSheetElements = _a[3]
        ...
        get: function get (target, property) {
          if (property === 'createElement') {
            return function createElement (tagName, options) {
              ...
              if ((tagName === null || tagName === undefined ? undefined : tagName.toLowerCase()) === 'style' || (tagName === null || tagName === undefined ? undefined : tagName.toLowerCase()) === 'script') {
