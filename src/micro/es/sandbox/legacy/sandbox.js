...
(function () {
  function SingularProxySandbox (name) {
    ...
    var _a = this
    var sandboxRunning = _a.sandboxRunning
    var addedPropsMapInSandbox = _a.addedPropsMapInSandbox
    var modifiedPropsOriginalValueMapInSandbox = _a.modifiedPropsOriginalValueMapInSandbox
    var currentUpdatedPropsValueMap = _a.currentUpdatedPropsValueMap
