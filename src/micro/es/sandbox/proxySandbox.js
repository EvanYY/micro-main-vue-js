...
function createFakeWindow (global) {
  ...
  Object.getOwnPropertyNames(global).filter(function (p) {
    ...
    return !(descriptor === null || descriptor === undefined ? undefined : descriptor.configurable)
  }).forEach(function (p) {
    var descriptor = Object.getOwnPropertyDescriptor(global, p)
...
(function () {
  function ProxySandbox (name) {
    ...
    var updateValueMap = _a.updateValueMap // https://github.com/umijs/qiankun/pull/192
