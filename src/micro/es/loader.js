...
export function loadApp (app, configuration, lifeCycles) {
  ...
  return __awaiter(this, undefined, undefined, function () {
    ...
    return __generator(this, function (_m) {
      const _label = _m.label
      if (_label === 0) {
        entry = app.entry
        appName = app.name
        _a = configuration.singular
        singular = _a === undefined ? false : _a
        _b = configuration.sandbox
        sandbox = _b === undefined ? true : _b
        importEntryOpts = __rest(configuration, ['singular', 'sandbox'])
        return [4,
          /* yield*/
        ...
        _f = _d.afterUnmount
        afterUnmount = _f === undefined ? [] : _f
        _g = _d.afterMount
        afterMount = _g === undefined ? [] : _g
        _h = _d.beforeMount
        beforeMount = _h === undefined ? [] : _h
        _j = _d.beforeLoad
        beforeLoad = _j === undefined ? [] : _j
        return [4,
          /* yield*/
        ...
        _k = getLifecyclesFromExports(scriptExports, appName, global)
        bootstrap = _k.bootstrap
        mount = _k.mount
        unmount = _k.unmount
        update = _k.update
        _l = getMicroAppStateActions(appInstanceId)
