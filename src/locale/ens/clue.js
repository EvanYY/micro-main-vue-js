export default {
  ...
  clue: 'clue',
  emailOrPhoneRepeat: 'Email or cell phone repeat',
  ...
  clueSetDelTip1: '] is about to be deleted. After the field is deleted, you cannot view the field information in the leads module.',
  clueSetDelTip2: '] is being used by ',
  clueSetDelTip3: '. After the field is deleted, the information of the field cannot be viewed and synchronized in the corresponding modules such as leads, website messages, and Facebook leads.',
